...
public class Foundry extends Building {
    ...
    private final double basePower = 16;
    ...
    public Foundry(Point position, boolean recipeSet, Recipe recipe, double overclock) {
        this.position = position;
    ...
    private void initializeRecipes() {
        possibleRecipes = Recipes.getRecipeByBuilding(BuildingType.FOUNDRY);
    }

    private void getImages() {
        try {
            image = ImageIO.read(new File("resources/images/buildings/foundry.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void drawMenu(Graphics2D g2d) {
        ...
        g2d.drawString("Foundry", menuTopLeft.x + 10, menuTopLeft.y + 25);
