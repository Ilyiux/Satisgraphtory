...
public class Manufacturer extends Building {
    ...
    private final double basePower = 55;
    ...
    public Manufacturer(Point position) {
    ...
    public Manufacturer(Point position, boolean recipeSet, Recipe recipe, double overclock) {
        this.position = position;
    ...
    private void initializeRecipes() {
        possibleRecipes = Recipes.getRecipeByBuilding(BuildingType.MANUFACTURER);
    }

    private void getImages() {
        try {
            image = ImageIO.read(new File("resources/images/buildings/manufacturer.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void clicked(GraphicsPanel gp, int mx, int my) {
        ...
        if (mx > menuTopLeft.x + 10 && mx < menuTopLeft.x + 95 && my > menuTopLeft.y + 260 && my < menuTopLeft.y + 290) {
            gp.closeBuildingMenu();
            gp.addBuilding(new Manufacturer(position, recipeSet, recipe, overclock));
        }
    ...
    public void draw(boolean greyedOut, Graphics2D g2d) {
        ...
        String nameString = "Manufacturer";
    ...
    public void drawMenu(Graphics2D g2d) {
        ...
        g2d.drawString("Manufacturer", menuTopLeft.x + 10, menuTopLeft.y + 25);
