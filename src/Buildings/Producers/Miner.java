...
public class Miner extends Building {
    ...
    private void getImages() {
        try {
            image_mk1 = ImageIO.read(new File("resources/images/buildings/miner_mk1.png"));
            image_mk2 = ImageIO.read(new File("resources/images/buildings/miner_mk2.png"));
            image_mk3 = ImageIO.read(new File("resources/images/buildings/miner_mk3.png"));

            for (NodePossibilities n : NodePossibilities.values()) {
                itemIcons.put(n, ImageIO.read(new File("resources/images/items/" + String.valueOf(n).toLowerCase() + ".png")));
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
