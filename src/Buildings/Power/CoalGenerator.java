...
public class CoalGenerator extends Building {
    ...
    private void getImages() {
        try {
            image = ImageIO.read(new File("resources/images/buildings/coal_generator.png"));

            for (FuelPossibilities f : FuelPossibilities.values()) {
                itemIcons.put(f, ImageIO.read(new File("resources/images/items/" + String.valueOf(f).toLowerCase() + ".png")));
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void clicked(GraphicsPanel gp, int mx, int my) {
        ...
        // resource
        if (mx > GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 10 && mx < GraphicsPanel.WIDTH - 10 && my > 10 && my < 50) fuelType = FuelPossibilities.UNSET;
        if (mx > GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 10 && mx < GraphicsPanel.WIDTH - 10 && my > 60 && my < 100) fuelType = FuelPossibilities.COAL;
        if (mx > GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 10 && mx < GraphicsPanel.WIDTH - 10 && my > 110 && my < 150) fuelType = FuelPossibilities.COMPACTED_COAL;
        if (mx > GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 10 && mx < GraphicsPanel.WIDTH - 10 && my > 160 && my < 200) fuelType = FuelPossibilities.PETROLEUM_COKE;
    ...
    public void drawMenu(Graphics2D g2d) {
        ...
        g2d.drawImage(itemIcons.get(FuelPossibilities.UNSET), GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 20, 20, 20, 20, null);
        g2d.drawString("COAL", GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 50, 88);
        g2d.drawImage(itemIcons.get(FuelPossibilities.COAL), GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 20, 70, 20, 20, null);
        g2d.drawString("COMPACTED COAL", GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 50, 138);
        g2d.drawImage(itemIcons.get(FuelPossibilities.COMPACTED_COAL), GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 20, 120, 20, 20, null);
        g2d.drawString("PETROLEUM COKE", GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 50, 188);
        g2d.drawImage(itemIcons.get(FuelPossibilities.PETROLEUM_COKE), GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 20, 170, 20, 20, null);
