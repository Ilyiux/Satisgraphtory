...
public class NuclearPowerPlant extends Building {
    ...
    public NuclearPowerPlant(Point position) {
    ...
    public NuclearPowerPlant(Point position, double overclock, FuelPossibilities fuelType) {
        this.position = position;
    ...
    private void getImages() {
        try {
            image = ImageIO.read(new File("resources/images/buildings/nuclear_power_plant.png"));
    ...
    public void clicked(GraphicsPanel gp, int mx, int my) {
        ...
        if (mx > menuTopLeft.x + 10 && mx < menuTopLeft.x + 95 && my > menuTopLeft.y + 260 && my < menuTopLeft.y + 290) {
            gp.closeBuildingMenu();
            gp.addBuilding(new NuclearPowerPlant(position, overclock, fuelType));
        }
        ...
        if (mx > GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 10 && mx < GraphicsPanel.WIDTH - 10 && my > 60 && my < 100) fuelType = FuelPossibilities.URANIUM_FUEL_ROD;
        if (mx > GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 10 && mx < GraphicsPanel.WIDTH - 10 && my > 110 && my < 150) fuelType = FuelPossibilities.PLUTONIUM_FUEL_ROD;
    ...
    public void drawMenu(Graphics2D g2d) {
        ...
        g2d.drawString("URANIUM ROD", GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 50, 88);
        g2d.drawImage(itemIcons.get(FuelPossibilities.URANIUM_FUEL_ROD), GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 20, 70, 20, 20, null);
        g2d.drawString("PLUTONIUM ROD", GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 50, 138);
        g2d.drawImage(itemIcons.get(FuelPossibilities.PLUTONIUM_FUEL_ROD), GraphicsPanel.WIDTH - GraphicsPanel.WIDTH / 8 + 20, 120, 20, 20, null);
