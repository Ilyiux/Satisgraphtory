...
public class CoalGenerator extends Building {
    ...
    private final double basePower = 75;
    ...
    public CoalGenerator(Point position) {
    ...
    public CoalGenerator(Point position, double overclock, FuelPossibilities fuelType) {
        this.position = position;
    ...
    private void getImages() {
        image = Main.getImageFromResources("/images/buildings/coal_generator.png");
    ...
    private void updateItemRate() {
        ...
        waterRate = baseWaterRate * Math.pow(overclock / 100, 0.76923076923);
    ...
    public void clicked(GraphicsPanel gp, int mx, int my) {
        ...
        if (mx > menuTopLeft.x + 10 && mx < menuTopLeft.x + 95 && my > menuTopLeft.y + 260 && my < menuTopLeft.y + 290) {
            gp.closeBuildingMenu();
            gp.addBuilding(new CoalGenerator(position, overclock, fuelType));
        }
        ...
        if (mx > gp.getWidth() - buttonWidth - spacing && mx < gp.getWidth() - spacing && my > spacing * 2 + buttonHeight && my < (spacing + buttonHeight) * 2) fuelType = FuelPossibilities.COAL;
        if (mx > gp.getWidth() - buttonWidth - spacing && mx < gp.getWidth() - spacing && my > spacing * 3 + buttonHeight * 2 && my < (spacing + buttonHeight) * 3) fuelType = FuelPossibilities.COMPACTED_COAL;
        if (mx > gp.getWidth() - buttonWidth - spacing && mx < gp.getWidth() - spacing && my > spacing * 4 + buttonHeight * 3 && my < (spacing + buttonHeight) * 4) fuelType = FuelPossibilities.PETROLEUM_COKE;
    ...
    public void drawMenu(Graphics2D g2d, GraphicsPanel gp) {
        ...
        g2d.drawString("Coal Generator", menuTopLeft.x + 10, menuTopLeft.y + 25);
        ...
        g2d.drawString("COAL", gp.getWidth() - (int)(gp.getHeight() * 1.77777777) / 8 + spacing * 5, (spacing + buttonHeight) * 2 - (int)(spacing * 1.2));
        g2d.drawImage(itemIcons.get(FuelPossibilities.COAL), gp.getWidth() - (int)(gp.getHeight() * 1.77777777) / 8 + spacing * 2, spacing * 3 + buttonHeight, imageSize, imageSize, null);
        g2d.drawString("COMPACTED COAL", gp.getWidth() - (int)(gp.getHeight() * 1.77777777) / 8 + spacing * 5, (spacing + buttonHeight) * 3 - (int)(spacing * 1.2));
        g2d.drawImage(itemIcons.get(FuelPossibilities.COMPACTED_COAL), gp.getWidth() - (int)(gp.getHeight() * 1.77777777) / 8 + spacing * 2, spacing * 4 + buttonHeight * 2, imageSize, imageSize, null);
        g2d.drawString("PETROLEUM COKE", gp.getWidth() - (int)(gp.getHeight() * 1.77777777) / 8 + spacing * 5, (spacing + buttonHeight) * 4 - (int)(spacing * 1.2));
        g2d.drawImage(itemIcons.get(FuelPossibilities.PETROLEUM_COKE), gp.getWidth() - (int)(gp.getHeight() * 1.77777777) / 8 + spacing * 2, spacing * 5 + buttonHeight * 3, imageSize, imageSize, null);
