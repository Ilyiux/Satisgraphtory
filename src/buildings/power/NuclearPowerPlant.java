...
public class NuclearPowerPlant extends Building {
    ...
    public void clicked(GraphicsPanel gp, int mx, int my) {
        ...
        if (mx > gp.getWidth() - buttonWidth - spacing && mx < gp.getWidth() - spacing && my > spacing * 2 + buttonHeight && my < (spacing + buttonHeight) * 2) fuelType = FuelPossibilities.URANIUM_FUEL_ROD;
        if (mx > gp.getWidth() - buttonWidth - spacing && mx < gp.getWidth() - spacing && my > spacing * 3 + buttonHeight * 2 && my < (spacing + buttonHeight) * 3) fuelType = FuelPossibilities.PLUTONIUM_FUEL_ROD;
    ...
    public void drawMenu(Graphics2D g2d, GraphicsPanel gp) {
        ...
        g2d.drawString("URANIUM ROD", gp.getWidth() - (int)(gp.getHeight() * 1.77777777) / 8 + spacing * 5, (spacing + buttonHeight) * 2 - (int)(spacing * 1.2));
        g2d.drawImage(itemIcons.get(FuelPossibilities.URANIUM_FUEL_ROD), gp.getWidth() - (int)(gp.getHeight() * 1.77777777) / 8 + spacing * 2, spacing * 3 + buttonHeight, imageSize, imageSize, null);
        g2d.drawString("PLUTONIUM ROD", gp.getWidth() - (int)(gp.getHeight() * 1.77777777) / 8 + spacing * 5, (spacing + buttonHeight) * 3 - (int)(spacing * 1.2));
        g2d.drawImage(itemIcons.get(FuelPossibilities.PLUTONIUM_FUEL_ROD), gp.getWidth() - (int)(gp.getHeight() * 1.77777777) / 8 + spacing * 2, spacing * 4 + buttonHeight * 2, imageSize, imageSize, null);
